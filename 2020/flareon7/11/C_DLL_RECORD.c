...
//****  WordlibSystemser_export.dll  文件读写，还有一个类似计算flag的复杂函数。
...
//case: 0xb961999e
//case: 0xb961999e
case: 0xf6c9f0a0 if ( !key )
          return v6;
        key_content = d6306e08_50_memcpy(key, 16i64);
        if ( !key_content )
          return 8;
        buf = d6306e08_29(mem + 184, mem, key_content);// very important
        if ( buf )
          _8576b0d0_11_heap_free(buf);
        return 0;
//case: 0xb894999e
//case: 0xb961999e
//case: 0xb961999e
