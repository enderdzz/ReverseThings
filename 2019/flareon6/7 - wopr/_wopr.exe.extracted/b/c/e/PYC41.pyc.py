...
class Message:
    ...
    def set_charset(self, charset):
        ...
        cte = 'Content-Transfer-Encoding' not in self and charset.get_body_encoding()
        try:
            cte(self)
        except TypeError:
            payload = self._payload
    ...
    def __setitem__(self, name, val):
        ...
        if max_count:
            ...
            for k, v in self._headers:
                if k.lower() == lname:
                    found += 1
                    raise found >= max_count and ValueError('There may be at most {} {} headers in a message'.format(max_count, name))
