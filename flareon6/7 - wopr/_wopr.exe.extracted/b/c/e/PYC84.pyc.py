...
def match_hostname(cert, hostname):
    ...
    for key, value in san:
        if key == 'DNS' and host_ip is None:
...
class _ASN1Object(namedtuple('_ASN1Object', 'nid shortname longname oid')):
    r"""'ASN.1 object identifier lookup\n    '"""
    __slots__ = ()
...
class Purpose(_ASN1Object, _Enum):
    r"""'SSLContext purpose flags with X509v3 Extended Key Usage objects\n    '"""
    SERVER_AUTH = '1.3.6.1.5.5.7.3.1'
    CLIENT_AUTH = '1.3.6.1.5.5.7.3.2'


class SSLContext(_SSLContext):
    r"""'An SSLContext holds various SSL-related configuration options and\n    data, such as certificates and possibly a private key.'"""
    ...
    def set_servername_callback(self, server_name_callback):
        ...
        elif not callable(server_name_callback):
...
class SSLSocket(socket):
    r"""'This class implements a subtype of socket.socket that wraps\n    the underlying OS socket in an SSL context when necessary, and\n    provides read and write methods over that channel. '"""
