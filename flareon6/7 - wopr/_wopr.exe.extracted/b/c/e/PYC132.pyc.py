...
class Finder(metaclass=abc.ABCMeta):
    r"""'Legacy abstract base class for import finders.\n\n    It may be subclassed for compatibility with legacy third party\n    reimplementations of the import system.  Otherwise, finder\n    implementations should derive from the more specific MetaPathFinder\n    or PathEntryFinder ABCs.\n\n    Deprecated since Python 3.3\n    '"""
...
class ResourceLoader(Loader):
    r"""'Abstract base class for loaders which can return data from their\n    back-end storage.\n\n    This ABC represents one of the optional protocols specified by PEP 302.\n\n    '"""
...
class ExecutionLoader(InspectLoader):
    r"""'Abstract base class for loaders that wish to support the execution of\n    modules as scripts.\n\n    This ABC represents one of the optional protocols specified in PEP 302.\n\n    '"""
...
class FileLoader(_bootstrap_external.FileLoader, ResourceLoader, ExecutionLoader):
    r"""'Abstract base class partially implementing the ResourceLoader and\n    ExecutionLoader ABCs.'"""
    pass
